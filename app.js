...
document.addEventListener('DOMContentLoaded', function() {
  ...
  /* ==========================================================================
     5. Interactive Reachable Phone & Contact Quick Actions
     ========================================================================== */
  ...
  function copyToClipboard(text, btnElement, labelElement, originalText, iconElement) {
    ...
    function fallbackCopy() {
      try {
        ...
        showToast('Could not copy automatically. Number: ' + text, 'fa-solid fa-triangle-exclamation');
      }
    }

    function onSuccess() {
      showToast(`Copied <strong>${text}</strong> to clipboard!`, 'fa-solid fa-copy');
      ...
      if (btnElement) {
        ...
        setTimeout(() => {
          ...
          if (labelElement) labelElement.textContent = originalText;
          if (iconElement) iconElement.className = 'fa-regular fa-copy';
        }, 2000);
      }
    }
  }
  ...
  if (copyPhoneBtn) {
    copyPhoneBtn.addEventListener('click', function(e) {
      ...
      const icon = document.getElementById('copy-phone-icon');
      copyToClipboard('+91 8122241705', copyPhoneBtn, label, 'Copy', icon);
    });
  }
  ...
  if (copyEmailBtn) {
    copyEmailBtn.addEventListener('click', function(e) {
      ...
      copyToClipboard('aminahmedg2005@gmail.com', copyEmailBtn, label, 'Copy Email', icon);
    });
  }

  // Floating Quick Contact Widget Toggle
  ...
  if (floatingCopyBtn) {
    floatingCopyBtn.addEventListener('click', function(e) {
      e.preventDefault();
      copyToClipboard('+91 8122241705');
